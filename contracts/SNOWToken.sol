...
/** 
  @notice
  An ERC-20 token that can be used by a project in the `SNOWTokenStore`.

  @dev
  Adheres to -
  ISNOWToken: Allows this contract to be used by projects in the SNOWTokenStore.
...
*/
contract SNOWToken is ERC20Permit, Ownable, ISNOWToken {
  //*********************************************************************//
  // ------------------------- external views -------------------------- //
  //*********************************************************************//
  ...
  */
  function decimals() public view override(ERC20, ISNOWToken) returns (uint8) {
