...
/** 
  ...
  @dev
  Adheres to -
  ISNOWOperatorStore: General interface for the methods in this contract that interact with the blockchain's state according to the protocol's rules.
*/
contract SNOWOperatorStore is ISNOWOperatorStore {
  //*********************************************************************//
  // --------------------------- custom errors ------------------------- //
  //*********************************************************************//
  ...
  */
  function setOperator(SNOWOperatorData calldata _operatorData) external override {
  ...
  */
  function setOperators(SNOWOperatorData[] calldata _operatorData) external override {
