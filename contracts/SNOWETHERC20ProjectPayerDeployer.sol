...
import './interfaces/ISNOWETHERC20ProjectPayerDeployer.sol';
...
/** 
  ...
  @dev
  Adheres to -
  ISNOWETHERC20ProjectPayerDeployer:  General interface for the methods in this contract that interact with the blockchain's state according to the protocol's rules.
*/
contract SNOWETHERC20ProjectPayerDeployer is ISNOWETHERC20ProjectPayerDeployer {
  //*********************************************************************//
  ...
  */
  function deployProjectPayer(
    ...
    address _owner
  ) external override returns (ISNOWProjectPayer projectPayer) {
    // Deploy the project payer.
    projectPayer = new SNOWETHERC20ProjectPayer(
      _defaultProjectId,
      _defaultBeneficiary,
