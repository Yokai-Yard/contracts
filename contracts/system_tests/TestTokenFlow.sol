...
/// @notice This file tests SNOWToken related flows
contract TestTokenFlow is TestBaseWorkflow {
  ...
  function testFuzzTokenFlow(
    ...
    // create a new ISNOWToken and change it's owner to the tokenStore
    ISNOWToken _newToken = new SNOWToken('NewTestName', 'NewTestSymbol');
    ...
    // confirm the project's new SNOWToken
