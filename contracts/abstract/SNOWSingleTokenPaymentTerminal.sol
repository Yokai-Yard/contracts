...
import './../interfaces/ISNOWSingleTokenPaymentTerminal.sol';
...
/**
  ...
  @dev
  Adheres to -
  ISNOWSingleTokenPaymentTerminals: General interface for the methods in this contract that interact with the blockchain's state according to the protocol's rules.

  @dev
  Inherits from -
  ERC165: Introspection on interface adherance. 
*/
abstract contract SNOWSingleTokenPaymentTerminal is ERC165, ISNOWSingleTokenPaymentTerminal {
  //*********************************************************************//
  ...
  */
  ...
  {
    return
      _interfaceId == type(ISNOWPaymentTerminal).interfaceId ||
      _interfaceId == type(ISNOWSingleTokenPaymentTerminal).interfaceId ||
